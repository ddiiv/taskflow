// Carga inicial: equipo, proyectos y tareas.
// No hace nada si la base ya tiene contenido.
//
...
function finDeMes() {
  ...
  return new Date(d.getFullYear(), d.getMonth() + 1, 0)
    .toLocaleDateString('sv-SE'); // sv-SE ya devuelve YYYY-MM-DD en hora local
}
...
console.log(
  `Cargado: ${miembro.size} personas, ${PROYECTOS.length} proyectos, ${totalTareas} tareas.`,
);
